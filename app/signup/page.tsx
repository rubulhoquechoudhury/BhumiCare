        ...
        <div className="glass-card-strong p-8 sm:p-10">
          <div className="mb-8 text-center">
            ...
            <p className="text-text-secondary text-sm mt-2">
              Start analyzing your soil for tea cultivation
            </p>
          </div>

          <form onSubmit={handleSignup} className="space-y-5">
            <div>
              <label htmlFor="signup-name" className="block text-sm font-semibold text-text-primary mb-2">
                Full Name
              </label>
              <input
                id="signup-name"
            ...
            <div>
              <label htmlFor="signup-email" className="block text-sm font-semibold text-text-primary mb-2">
                Email Address
              </label>
              <input
                id="signup-email"
            ...
            <div>
              <label htmlFor="signup-password" className="block text-sm font-semibold text-text-primary mb-2">
                Password
              </label>
              <input
                id="signup-password"
